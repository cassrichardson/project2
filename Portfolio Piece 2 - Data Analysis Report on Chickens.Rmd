...
climbing <- read.csv(here::here("C:/Users/cassr/GitHub/project01/Boulder_Safety_and_Stars.csv"))
...
chi_square
```
# Step 9: Let's conduct a one-way Analysis of Variance (ANOVA) test to see if the is a statistically significant difference in the average star rating between the different difficulties of routes.  
...
# Step 10: Since there are more than two levels of the IV (route difficulty), we need to run post-hoc tests to see which diets are significantly different from each other. 
